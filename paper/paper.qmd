...
figure sizes: 
Small: approximately 9 cm x 6 cm (3.5 in x 2.4 in)
Medium: approximately 11 cm x 11 cm (4.3 in x 4.3 in)
Large: approximately 18 cm x 22 cm (7.1 in x 8.7 in)
...
In light of the scientific racist origins of Pioneer and MQ, and the significant attention MQ has received in recent historiography, we hypothesized that MQ might have served as an "incubator" for race science discourse, with ideas originating in MQ before appearing within the scientific mainstream.  Establishing venues for favorable research is another key element of the "tobacco strategy" for manufacturing doubt [@FernandezPintoKnowBetterNot2017].  Specifically, we hypothesized that bibliometric and text mining analyses would show race science discourse appearing first in MQ, and subsequently appearing in mainstream publications.  This hypothesis was not supported.  Instead, mainstream psychology journals provided a venue for a distinct form of race science discourse, based on intelligence research and originating outside of MQ.  
...
![Journals publishing 6 or more Pioneer-funded researchers, Web of Science author search results.](img/pf_wos_results.png){#fig-wos width="7.1in" height="3.5in" fig-env="figure*"}
...
![Count of documents in the corpus, by journal and year.](img/02_count.png){#fig-counts width="3.5in" height="2.4in" fig-env="figure*"}
