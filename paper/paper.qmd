...
- figure out renv::restore()
    - re-make
    - copy updated plots
- figure sizes
- align abstract w/ intro
- figures and tables to end
]*
...
### Mainstream journals {.unnumbered}
...
## Vocabulary selection {.unnumbered}
