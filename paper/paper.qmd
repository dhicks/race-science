...
- NHB reviews todo
- sort git tree
- reorganize into PNAS ms + SI
- check cite formatting
- copy updated plots? 
- abstract formatting
- figure sizes
]*
...
The public analysis repository, <!-- <https://github.com/dhicks/race-science> --> *[URL and DOI will go here]*, includes document metadata and documentwise counts of NLP-extracted noun phrases ("document-term matrices"), along with code to reproduce the analysis of the following sections. 
...
![Silge plots (top 15 terms) for each topic and model, large vocabulary.](supplements/S2-lg-silge.pdf){#fig-silge-lg}

![Silge plots (top 15 terms) for each topic and model, medium vocabulary.](supplements/S3-md-silge.pdf){#fig-silge-md}

![Silge plots (top 15 terms) for each topic and model, small vocabulary.](supplements/S4-sm-silge.pdf){#fig-silge-sm}

![Topics with "race," "intelligence," or both occurring in the top 15 terms, large vocabulary.](supplements/S5_grid_lg.pdf){#fig-grid-lg}

![Topics with "race," "intelligence," or both occurring in the top 15 terms, medium vocabulary.](supplements/S6_grid_md.pdf){#fig-grid-md}

![Topics with "race," "intelligence," or both occurring in the top 15 terms, small vocabulary.](supplements/S7_grid_sm.pdf){#fig-grid-sm}
