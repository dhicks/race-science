...
After XML/PDF versions were retrieved, text was extracted using either the `xml2` package [@WickhamXml2ParseXML2023] or `pdftools`.  @fig-counts and @tbl-counts show the number of fulltext documents included in the corpus.  All together, the corpus includes 34,896 documents from 6 journals.  
