...
Considering the five strategies identified by @FernandezPintoKnowBetterNot2017, the Pioneer Fund itself clearly exemplifies the strategy of supporting friendly research; and figures such as Shockley and Jensen exemplify the strategy of recruiting high-profile, distinguished scientists [@TuckerFundingScientificRacism2002]. 


In @FernandezPintoKnowBetterNot2017, the Tobacco Industry Research Committee/Council for Tobacco Research provides the paradigm for supporting friendly research. @FernandezPintoKnowBetterNot2017 points out that the TIRC/CTR funded "scientific experts in major universities and research institutions" rather than marginal, fringe, or industry-employed scientists. The purpose was "to use 'good' research as a distraction" from the harmful effects of smoking by "fund[ing] research on heredity, infection, nutrition, hormones, nervous tension, and environmental factors" as causes of lung cancer and heart disease (57). This process of "industrial selection" for favorable research [@HolmanExperimentationIndustrialSelection2017] created the misleading impression that these non-tobacco causes were just as important, perhaps even more important, than smoking [compare @WeatherallHowBeatScience2018; @OConnorMisinformationAgeHow2019]. Similarly, per Laughlin, the Pioneer Fund was explicitly created to promote research on eugenics and race science as just as important, if not more important, than a supposed "equalitarian dogma" and "environmentalist" explanations of racial inequality *[cite]*. 

A key aim of the TIRC/CTR was to recruit friendly scientists, "distinguished scientists, whose authority and academic connections would help the industry’s goal of fostering uncertainty about scientific claims" [@FernandezPintoKnowBetterNot2017 57]. One prominent example not discussed by Fernández is statistician Ronald Fisher [@StolleyWhenGeniusErrs1991; @GundleProveThisIndustrys2010], who proposed a series of genetic explanations for the correlation between smoking and lung cancer in the last few years of his life. *[Shockley and Jensen]*



For the current project, we hypothesized that MQ and certain mainstream journals played a key role in another strategy identified by @FernandezPintoKnowBetterNot2017, the "echo chamber effect." We theorize this effect as involving three components: the "margins," the "mainstream," and the "bridge."  @FernandezPintoKnowBetterNot2017 argues that, using sponsored journals and conferences, "the tobacco industry circumvented peer review standards in publication, without compromising its façade of research supporter" (59). These kinds of marginal venues provide a "safe space" in which favorable conceptual frameworks and empirical research (or pseudo-research) could be developed, protected from the destructive critical scrutiny they would receive in the mainstream. Bridge venues are accepted as part of the mainstream, but cite and draw on work from the margins, thereby mainstreaming these marginal ideas, that is, making them appear to be part of the legitimate body of mainstream scientific research. 
...
(E) Empirical density plots of mean difference between paper share and author share for 1,000 randomly drawn sets of 15 authors. Bold vertical lines are the mean values for the Pioneer-funded authors (signed length of lines in panel D). Pioneer-funded authors are similar to randomly drawn sets for topics 7 and 22, but very different for topic 24. ](img/15_presence.png){#fig-presence}

*[more details in supplement]*

Post hoc, we were interested in trying to understand the impact that Pioneer might have had as an institution for supporting friendly scientists. (We thank a reviewer for suggesting this further analysis.) Because we did not have citation data, we were unable to examine "impact" in its usual sense of citations. Instead we chose to examine "presence," which we operationalize as the difference between the share of papers (published in a given topic in a given year) with at least one Pioneer-funded author ("paper share") against the share of all authors (again, for papers published in a given topic in a given year; individuated by family name) who were on our list of Pioneer-funded authors ("author share"). Positive values of "presence" would indicate that Pioneer-funded authors publish more (in a given topic) than might be expected. 

Because this was a post hoc analysis, we elected to examine "presence" only for the three focal topics for the medium vocabulary, $k=40$ model (fig. @fig-focal). Fig. @fig-presence shows the results of this analysis. 

Fig. @fig-presence A shows that topics 7 (MQ-style race science) and 24 (race-and-intelligence) had stable numbers of authors over the scope of the study, while topic 22 (mainstream intelligence) saw an exponential-like increase. Fig. @fig-presence B indicates that Pioneer-funded authors were a relatively high share of authors in topic 24, often comprising more than 10% of all authors in this topic after 1980. In contrast, these authors were almost never more than 10% of all authors in the other two topics. 

Fig. @fig-presence C shows that a greater share of papers in topic 24 had Pioneer-funded authors, compared to the other two topics, throughout the scope of the study but especially after about 1980. 

Fig. @fig-presence D is a scatterplot of paper share (subfigure C) against author share (subfigure B). Points above the dark diagonal line (length of the thin colored lines) indicate that, in that year-topic combination, Pioneer-funded authors' paper share was greater than their author share, and in this sense had a disproportionate "presence." For topic 7 (MQ-style race science), Pioneer-funded authors frequently had a small, disproportionately *negative* presence. While for topic 22 (mainstream intelligence) Pioneer-funded authors had a small or modest disproportionately positive presence. In contrast, for topic 24 (race-and-intelligence), Pioneer-funded authors had a substantial, disproportionately positive presence, with in some cases differences between paper share and author share of 20 points or more. 

To contextualize this measure of "presence," for each topic we used a permutation-style approach, drawing random sets of 15 authors (who ever published in the topic) and calculating paper share and author share in the same way as for Pioneer-funded authors. Fig. @fig-presence E shows the resulting distribution of mean presence (difference between paper share and author share) across 1,000 such permutations, with vertical lines for the observed values for the Pioneer-funded authors. Compared to the permutations, the Pioneer-funded authors do not have a distinctive presence for topics 7 and 22, but are at the rightmost extreme for topic 24. 
...
Using scientometric and text-mining methods, this study finds that Pioneer-funded researchers published heavily in certain mainstream psychology journals, much more than in *Mankind Quarterly*; that a distinct version of race science discourse, centered on race and intelligence, can be identified in these same mainstream journals across the period 1960-2010; and that authors funded by the Pioneer Fund had a disproportionate presence in this latter race science discourse.  These findings indicate that *Mankind Quarterly* (MQ) was a less important venue for late 20th century race science discourse than mainstream psychology journals — especially *Intelligence* (Int) and *Personality and Individual Differences* (PID).  Indeed, until the 1990s, MQ published a very different kind of race science discourse from the race-and-intelligence research published in Int and PID.  During this same period of time, race scientists served in prominent and influential positions in behavior genetics and psychology, including as society presidents and members of journal editorial boards.  In some cases, some race scientists simultaneously maintained active connections to both the mainstream scientific community and white supremacist organizations [@WinstonScientificRacismNorth2020; @JacksonJr.ArthurJensenEvolutionary2022; @SlobodianUnequalMindHow2023].  Thus the emphasis on MQ in race science historiography may have been misplaced. At the same time, the Pioneer Fund may have played a role in promoting race-and-intelligence research in mainstream psychology. 


## Agnogenesis within the scientific community

In terms of the margins-mainstream-bridge model of the "echo chamber effect," there was no bridge that carried ideas originating in MQ on the margins to mainstream journals, because the kind of race science discourse that originated in MQ did not spread to the mainstream. At the same time, within the scope of our data, the race-and-intelligence version of race science discourse was always a mainstream phenomenon.  
