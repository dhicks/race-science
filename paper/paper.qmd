...
In light of the scientific racist origins of Pioneer and MQ, and the significant attention MQ has received in recent historiography, we hypothesized that MQ might have served as an "incubator" for race science discourse, with ideas originating in MQ before appearing within the scientific mainstream.  Establishing venues for favorable research is another key element of the "tobacco strategy" for manufacturing doubt [@FernandezPintoKnowBetterNot2017].  Specifically, we hypothesized that scientometric and text mining analyses would show race science discourse appearing first and more prominently in MQ, and appearing in mainstream publications only subsequently.  This hypothesis was not supported.  Instead, mainstream psychology journals provided a venue for a distinct form of race science discourse, based on intelligence research and originating outside of MQ.  
