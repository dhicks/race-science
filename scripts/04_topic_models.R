...
## Loop over vocabs ----
process_vocab = function(this_vocab, 
                         vocab_name, 
                         force = FALSE, 
                         verbose = FALSE,
                         ...) {
...
# debugonce(process_vocab)
# process_vocab(vocabs$md, 'md', force = TRUE, verbose = TRUE)
set.seed(2023-04-15)
iwalk(vocabs, process_vocab, force = force, verbose = TRUE)
